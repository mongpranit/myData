<div style="width:268px;display:inline-block;vertical-align:top;">
    <a href="images/accommodation/GrandDeluxe/001.jpg" rel="colorbox1" title="">
        <img src="images/accommodation/GrandDeluxe/001.jpg"/>
    </a>
    <a href="images/accommodation/GrandDeluxe/002.jpg" rel="colorbox1" title="">
        <img src="images/accommodation/GrandDeluxe/002.jpg"/>
    </a>
</div>
<div style="width:360px;display:inline-block;vertical-align:top;">
    ...
    <form action="bookingInformation.php" method="post">
    	<input type="hidden" name="room" value="Grand Duplex"/>
        <input type="hidden" name="description" value="duplex_suite.php"/>
